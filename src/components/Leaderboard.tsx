    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-amber-950 dark:to-gray-900 p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">أفضل القراء على بلوكشين Celo</p>
        </div>
          ...
          {leaderboard.map((entry) => {
            ...
            return (
              <div
                key={entry.address}
                className={`${
                  entry.rank <= 3 ? getRankColor(entry.rank) + ' text-white' : 'bg-white dark:bg-gray-800 text-gray-900 dark:text-white'
                } ${
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">قراءة 5 صفحات</p>
                <p className="text-sm text-gray-600">اكسب 5 نقاط عن كل 5 صفحات تقرأها</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
